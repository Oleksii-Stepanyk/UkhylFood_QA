...
public class RestaurantOrderConsumerTests
{
    ...
    private readonly Mock<ILogger<RestaurantOrderConsumer>> _mockLogger;
    private readonly RestaurantOrderConsumer _consumer;
    private readonly Mock<ConsumeContext<Order>> _mockContext;

    public RestaurantOrderConsumerTests()
    {
        _mockOrderService = new Mock<IOrderService>();
        _mockLogger = new Mock<ILogger<RestaurantOrderConsumer>>();
        _consumer = new RestaurantOrderConsumer(_mockOrderService.Object, _mockLogger.Object);
